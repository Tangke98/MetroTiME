#' Uses ROGUE to evaluate the clustering of myeloid cells based on metabolic genes.
...
inte_use<-readRDS(paste0(integrated_object_path_myeloid,'myeloid_integration_sub_annotation_celltype_metatype.rds'))
