#' Associates function score with the MetaRegulon score in myeloid cells.
#' @param integrated_object_path_myeloid Path to the myeloid cells Metacell TPM file.
#' @param myeloid_metabolic_score Path to the metabolic score file.
#' @param myeloid_feature_score Path to the function score file.
#' @param myeloid_DEM Path to the differentially enriched MetaModule file.
