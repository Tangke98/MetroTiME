# Analyzes the trajectory of myeloid cells using STREAM.
# @param myeloid_file Path to the myeloid cells object file.
...
new_features=pd.read_csv(myeloid_file+'myeloid_integration_sub.gsva.csv',
                        index_col=0)
