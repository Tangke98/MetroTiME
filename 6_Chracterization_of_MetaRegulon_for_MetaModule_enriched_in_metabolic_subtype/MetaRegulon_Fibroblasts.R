#' Identifies MetaRegulon in fibroblasts.
#' @param integrated_object_path_fibroblasts Path to the fibroblasts object.
#' @param fibroblasts_DEG Path to the differentially expressed genes of fibroblasts.
#' @param fibroblasts_DEM Path to the differentially enriched MetaModule score of fibroblasts.
