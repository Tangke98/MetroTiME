...
Metabolic reprogramming is recognized as a hallmark of cancer, yet the mechanisms driving metabolic state heterogeneities and their regulation within the tumor microenvironment remain poorly understood. To address this, we developed MetroSCREEN, a tool that synergistically integrates intrinsic gene regulation with extrinsic cellular interactions, accurately predicting potential regulators with high consistency with single-cell perturbation results. Building on this, we introduced MetroTIME, a framework that applies MetroSCREEN across a comprehensive pan-cancer single-cell atlas, which includes over 700,000 fibroblasts and myeloid cells from 36 cancer types. This framework is structured into five main modules: collection of tumor-related single-cell datasets, integrated data analysis with MetroSCREEN, pan-cancer MetaModule analysis, pan-cancer MetaRegulon analysis, and large-scale cohort validation.
<img src="https://github.com/Tangke98/MetroTiME/blob/main/Image/MetroTIME_workflow.png" alt="Image Description" width="100%" />
